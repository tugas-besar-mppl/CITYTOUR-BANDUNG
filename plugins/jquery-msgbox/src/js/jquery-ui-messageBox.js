...
(function ($, window, document, undefined) {
	...
	var MessageBox = {
		...
		getDialogContent: function () {
			...
			var dialogView = "<div style='height:15px;'></div>";
				...
				dialogView += "</div>";
				dialogView += "<div style='float:left;' id='content-msgbox'>";
	...
	$.showMessageBox.options = {
		...
		type: 'Informasi',
		imagePath: 'plugins/jquery-msgbox/src/img/',
		AdditionalInformation: '',
		AdditionalInformationShowText: 'Tampilkan info tambahan',
		AdditionalInformationHideText: 'Sembuyikan info tambahan'
	};
	...
	var MessageBoxDialog = {
		...
		createDialogTemplate: function (title, content) {
			var result = "<div id='dialog-modal-msgbox' title='" + title + "'>";
					result += "<div class='dialog-content-msgbox' style='height:100%;width:100%;min-width:260px;'>";
						result += content;
					result += "</div>";
				result += "</div>";
