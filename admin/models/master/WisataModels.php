  ...
  $aColumns = array("NO","Paket","Keterangan","Harga","StatusAktif","IdWisata");
  $aColumnsType = array("string","string","string","double","string","string");						 
		
  $strQuery = "SELECT  @curRow := @curRow + 1 AS NO, IdWisata, Paket, Keterangan, Harga, StatusAktif, StatusDelete FROM m_wisata  
					  JOIN (SELECT @curRow := 0) AS rNO WHERE StatusDelete = 'T' ";
					 
  $strQueryCount = "SELECT COUNT(IdWisata) FROM m_wisata WHERE StatusDelete = 'T' ";
