  ...
  $aColumns = array("NO","Nama","Alamat","NoTelpon","StatusAktif","IdPetugas");
  $aColumnsType = array("string","string","string","string","string","string");						 
		
  $strQuery = "SELECT  @curRow := @curRow + 1 AS NO, IdPetugas, Nama, Alamat, NoTelpon, StatusAktif, StatusDelete FROM m_petugas  
					  JOIN (SELECT @curRow := 0) AS rNO WHERE StatusDelete = 'T' ";
					 
  $strQueryCount = "SELECT COUNT(IdPetugas) FROM m_petugas WHERE StatusDelete = 'T' ";
