...
<table width="100%" style="border:2" class="display" id="gridData">
  <thead>
  <tr>
    <th  align="center" colspan="8"><h3>Laporan Pembayaran</h3></th>    
  </tr> 
  <tr>
  	<th  align="center" colspan="8"><h4><?php echo "Dari Tanggal ".$_GET['tgl']." Sampai Dengan ".$_GET['tgl1'];?></h4></th>
  </tr>  
  <tr>
    <th width="100">No</th>
    <th width="100">No Booking</th>
    <th width="100">Tanggal Registrasi</th>    
    <th width="100">Jenis Kendaraan</th>
    <th width="100">Paket Wisata</th>
...
?>
  <tr class="list calibriTabel" align="center">
      <td><?php echo $no;?></td>
    <td><?php echo $rows->KodeBooking;?></td>
    <td><?php echo $rows->TanggalRegistrasi;?></td>    
    <td><?php echo $rows->Jenis;?></td>
    <td><?php echo $rows->Paket;?></td> 
    <td><?php echo $rows->Nama;?></td> 
    <td><?php echo $rows->JmlHari;?></td>    
    <td><?php echo number_format($rows->TotalHarga);?></td>
    
  </tr>
  
<?php 
	$total_penjualan = $total_penjualan  + $rows->TotalHarga;
	$no++;} ?>  
    </tbody>
    <tfoot>
    <tr>
